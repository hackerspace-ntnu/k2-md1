...
int N_FRAMES = 900;
const int iterframes = 50;

//const char*IMAGE_PATH = "../hackerspace/mapbot/k2-md1/src/reconstruct/hackscan2/";
//const char*POSE_FILE = "hackviews2.txt";
const char*IMAGE_PATH = "../scans/killer/";
const char*POSE_FILE = "killerviews.txt";

//const char*IMAGE_PATH = "/home/test/hackerspace/mapbot/k2-md1/src/reconstruct/recorded/";
//const char*POSE_FILE = "/home/test/hackerspace/mapbot/k2-md1/src/reconstruct/views.txt";
float host_img[w*h];
...
void dumpPose(FILE*fp, se3 pose) {
  se3 view = path[i]*-1;
...
int main(int argc, char**argv) {
  ...
  try {
    ...
    for (int scale = 0; scale < scales; scale++) {
      float f = 1.f/(1<<scale);
      float scaledprojection[4] = {(Dcx+0.5f)*f-0.5f, (Dcy+0.5f)*f-0.5f, Dpers*f, 1./(f*Dpers)};
